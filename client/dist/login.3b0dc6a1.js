...
if (loginForm) loginForm.addEventListener("submit", (e)=>{
    ...
    (0, _axiosDefault.default).post("/user/login", user).then((data)=>console.log(data.data)).catch((err)=>console.log(err));
});
...
},{}]},["bH6SS","fEc1V"], "fEc1V", "parcelRequiree8ef", {})

//# sourceMappingURL=login.3b0dc6a1.js.map
